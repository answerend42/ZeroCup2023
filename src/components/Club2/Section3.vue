...
<script>
import image1 from "@/assets/相声配图2.webp";
import image2 from "@/assets/相声配图3.webp";
import image3 from "@/assets/相声配图4.webp";
import backgroundImage from "@/assets/相声协会底图.webp";
export default {
  name: "Section3",
  data() {
    return {
