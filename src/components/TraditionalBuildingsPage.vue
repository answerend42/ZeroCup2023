...
export default {
  data() {
    return {
      cards: [
        { image: image1, contentBrief: 'Brief 1', contentFull: 'Full description for Card 1', expanded: false, fullscreen: false },
        { image: image2, contentBrief: 'Brief 2', contentFull: 'Full description for Card 2', expanded: false, fullscreen: false },
        { image: image3, contentBrief: 'Brief 3', contentFull: 'Full description for Card 3', expanded: false, fullscreen: false },
      ]
    };
  },
  methods: {
